        ...
        >
            <DialogTrigger asChild>
                <Button variant="outline" className="hover:bg-system_prince_700 hover:text-white">
                    <Plus className="mr-2" /> <p className="font-poppins_medium">Tipo Documento</p>
                </Button>
            </DialogTrigger>
            <DialogContent className="w-[900px] h-fit max-w-[80vw] max-h-[80vh] overflow-scroll">
                ...
                <form id="tipo_doc_form" onSubmit={handleSubmit(SubmitForm)} className="mb-5 mt-3 flex items-center gap-10">
                ...
                <LoadingButton loading={loading ? 'true' : 'false'} form="tipo_doc_form">
                    Cadastrar
                </LoadingButton>
            </DialogContent>
        </Dialog>
