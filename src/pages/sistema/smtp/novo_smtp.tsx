...
function NovoSmtp({ smtp, refetch }: { smtp: any; refetch: () => void }) {
    ...
    const [secure, setSecure] = useState(smtp && smtp.secure === 1 ? true : false);
    ...
    return (
        ...
        >
            <DialogTrigger asChild>
                <Button variant="outline" className="hover:bg-system_prince_700 hover:text-white">
            ...
            <DialogContent className="w-[900px] h-fit max-w-[80vw] max-h-[80vh] overflow-scroll">
                ...
                <form id="status_form" onSubmit={handleSubmit(SubmitForm)} className="mb-5 mt-3">
                    <div className="w-full">
                        <div className="flex gap-5 mt-5">
                            <div className="w-full">
                                ...
                                {errors.host && <p className="ml-1 text-system_red_600">{errors.host.message?.toString()}</p>}
                            </div>
                            ...
                            <div className="">
                                ...
                                {errors.port && <p className="ml-1 text-system_red_600">{errors.port.message?.toString()}</p>}
                            </div>
                        ...
                        <div className="mt-5">
                            ...
                            {errors.user && <p className="ml-1 text-system_red_600">{errors.user.message?.toString()}</p>}
                        </div>
                        ...
                        <div className="mt-5">
                            ...
                            {errors.pass && <p className="ml-1 text-system_red_600">{errors.pass.message?.toString()}</p>}
                        </div>
                    </div>
                </form>
