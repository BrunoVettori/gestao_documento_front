...
function EditarStatus({ status, refetch }: { status: any; refetch: () => void }) {
    const [loading, setLoading] = useState(false);
    const [open, setOpen] = useState(false);

    const [ativo, setAtivo] = useState(status.ativo === 1 ? true : false);
    ...
    return (
        ...
        >
            ...
            <DialogContent className="w-[900px] h-fit max-w-[80vw] max-h-[80vh] overflow-scroll">
                ...
                <form id="status_form" onSubmit={handleSubmit(SubmitForm)} className="mb-5 mt-3 flex gap-5">
