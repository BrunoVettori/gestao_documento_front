...
function Login() {
  ...
  useEffect(() => {
    const request = new Request(
      import.meta.env.VITE_BASE_URL + "/clear_cookie",
      {
        method: "POST",
        credentials: "include",
  ...
  return (
    <div className="h-fit w-fit rounded-sm bg-white flex flex-col items-center justify-center p-8">
      <div className="flex flex-col items-center gap-5">
        <img className="w-[150px]" src={logo} alt="RailenWeb" />

        <p className="font-nunito_semibold text-system_gray_700 text-2xl">
      ...
      <form onSubmit={handleSubmit(MakeLoginRequest)}>
        <div className="min-w-[350px] h-full flex flex-col gap-3 mt-5">
          ...
          <Button className="w-full bg-system_gray_700 hover:bg-system_gray_700 ">
            Login
          </Button>
        </div>
      </form>
