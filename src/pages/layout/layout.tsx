import { User, Building2, File, Power, UserPlus, Wrench, Mail } from 'lucide-react';
                        ...
                        <Tooltip delayDuration={50}>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    variant="ghost"
                                    className="w-full h-[50px] group border-r-[2px] border-l-[2px] hover:bg-system_gray_100 border-white hover:border-r-system_prince_800 rounded-none ease-in-out duration-200"
                                >
                                    <User color="#374151" />
                                </Button>
                            </TooltipTrigger>
                        ...
                        <Tooltip delayDuration={50}>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    variant="ghost"
                                    className="bg-system_prince_700 hover:bg-system_prince_800 rounded-full w-[50px] h-[50px]"
                                >
                                    <Power color="white" />
                                </Button>
                            </TooltipTrigger>
