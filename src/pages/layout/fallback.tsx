  ...
  if (path.includes("/login")) {
    ...
    return (
      <div className="min-w-[100vw] min-h-[100vh] flex flex-col bg-system_background">
        <div className="h-[75px] flex items-center justify-between bg-gradient-to-r from-black to-system_gray_900 shadow-md">
          <Button
            variant="outline"
            className="w-[100px] group border-r-[2px] hover:bg-system_gray_100 border-white hover:border-r-system_gray_900 rounded-none ease-in-out duration-200 p-[25px] h-full "
          >
