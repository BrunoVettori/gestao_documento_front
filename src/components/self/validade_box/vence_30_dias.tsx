...
function Vence30Dias({
    ...
    const query_documentos = useQuery({
        queryKey: [`lista_vence30dias`],
        queryFn: async () => {
            let request_query = `/documentos_valdiade?tipo=2`;
    ...
    if (!documentos) {
        ...
        return (
            <div className="flex items-center w-[400px] h-[150px] bg-system_gray_800 rounded-xl overflow-hidden">
                <p className="text-white text-2xl font-nunito_semibold ml-auto mr-auto">A Vencer em 30 dias</p>

                <div className="flex items-center justify-center bg-system_yellow_600 h-full min-w-[120px] w-fit ml-auto">
