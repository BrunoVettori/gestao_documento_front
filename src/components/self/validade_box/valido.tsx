...
function Valido({
    ...
    const query_documentos = useQuery({
        queryKey: [`lista_valido`],
        queryFn: async () => {
            let request_query = `/documentos_valdiade?tipo=1`;
    ...
    if (!documentos) {
        ...
        return (
            <div className="flex items-center w-[400px] h-[150px] bg-system_gray_800 rounded-xl overflow-hidden">
                <p className="text-white text-2xl font-nunito_semibold ml-auto mr-auto">Documentos Válidos</p>

                <div className="flex items-center justify-center bg-system_green_700 h-full min-w-[120px] w-fit ml-auto">
